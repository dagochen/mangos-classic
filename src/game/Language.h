...
//                                      = 783, not used
    ...
    // RaidStats
    LANG_RAIDSTATS_AUTOATTACK_OFF       = 1714,
    LANG_RAIDSTATS_AUTOATTACK_ON        = 1713,
    LANG_RAIDSTATS_EVADE_OFF            = 1718,
    LANG_RAIDSTATS_SPELL_ON             = 1715,
    LANG_RAIDSTATS_SPELL_OFF            = 1716,
    LANG_RAIDSTATS_EVADE_ON             = 1717,
    LANG_RAIDSTATS_HEAL_OFF             = 1720,
    LANG_RAIDSTATS_HEAL_ON              = 1719,
    LANG_RAIDSTATS_COMBAT_ON            = 1721,
    LANG_RAIDSTATS_COMBAT_OFF           = 1722,
    LANG_RAIDSTATS_KILL_ON              = 1723,
    LANG_RAIDSTATS_KILL_OFF             = 1724,
    LANG_RAIDSTATS_LOOT_ON              = 1725,
    LANG_RAIDSTATS_LOOT_OFF             = 1726,
    LANG_RAIDSTATS_LOOTPICK_OFF         = 1728,
    LANG_RAIDSTATS_LOOTPICK_ON          = 1727,
    LANG_RAIDSTATS_ALL_ON               = 1729,
    LANG_RAIDSTATS_ALL_OFF              = 1730,
