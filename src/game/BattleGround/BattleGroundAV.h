...
#define BG_AV_COMMANDER_A_MORTIMER      77
#define BG_AV_COMMANDER_A_DUFFY         78
#define BG_AV_COMMANDER_A_KARLPHILIPS   79
#define BG_AV_COMMANDER_A_RANDOLPH      80

#define BG_AV_COMMANDER_H_DARDOSH       81
#define BG_AV_COMMANDER_H_LOUISPHILIP   82
#define BG_AV_COMMANDER_H_MULFORT       83
#define BG_AV_COMMANDER_H_MALGOR        84

#define BG_AV_LIEUTENANT_H_GRUMMUS    85
#define BG_AV_LIEUTENANT_H_MURP       86
#define BG_AV_LIEUTENANT_H_STRONGHOOF 87
#define BG_AV_LIEUTENANT_H_RUGBA      88
#define BG_AV_LIEUTENANT_H_LEWIS      89
#define BG_AV_LIEUTENANT_H_VOLTALAR   90

#define BG_AV_LIEUTENANT_A_STOUTHANDLE 91
#define BG_AV_LIEUTENANT_A_GREYWAND    92
#define BG_AV_LIEUTENANT_A_LONADIN     93
#define BG_AV_LIEUTENANT_A_SPENCER     94
#define BG_AV_LIEUTENANT_A_MANUSCO     95
#define BG_AV_LIEUTENANT_A_LARGENT     96
...
{
    public:
        BattleGroundAVScore() : GraveyardsAssaulted(0), GraveyardsDefended(0), TowersAssaulted(0), TowersDefended(0), SecondaryObjectives(0), LieutnantCount(0), MineCount(0) {};
