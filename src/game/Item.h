...
class MANGOS_DLL_SPEC Item : public Object
{
    public:
        ...
        void SetEnchantment(EnchantmentSlot slot, uint32 id, uint32 duration, uint32 charges, ObjectGuid enchantCaster = ObjectGuid());
        void SetEnchantmentDuration(EnchantmentSlot slot, uint32 duration);
        void SetEnchantmentCharges(EnchantmentSlot slot, uint32 charges);
        void ClearEnchantment(EnchantmentSlot slot);
        ObjectGuid GetEnchantCaster() { return m_enchantCaster; };
